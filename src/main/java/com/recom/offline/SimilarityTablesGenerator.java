...
/*
 * @ClassName: SimilarityTablesGenerator
 * @projectName RecommendSys
 * @Auther: djr
 * @Date: 2019/8/25 15:24
 * @Description:generate item-item similarity table & user-item table, and insert into redis
 */
public class SimilarityTablesGenerator {
